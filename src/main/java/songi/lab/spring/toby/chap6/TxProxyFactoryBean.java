...
public class TxProxyFactoryBean implements FactoryBean<Object> {
    ...
    // 다이나믹 프록시를 생성할 때 필요. UserService외의 인터페이스를 가진 타깃에도 적용할 수 있다.
    ...
    public Object getObject() throws Exception {
        // DI 받은 정보를 이용해 TransactionHandler 를 사용하는 다이내믹 프록시를 생성한다.
    ...
    public boolean isSingleton() {
        // 싱글톤 빈이 아니라는 뜻이 아닌, getObject()가 매번 같은 오브젝트를 리턴하지 않는다는 의미다.
        return false;
    }
}
